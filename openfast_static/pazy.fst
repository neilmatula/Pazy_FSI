...
"FATAL"       AbortLevel      - Error level when simulation should abort (string) ["WARNING", "SEVERE", "FATAL"]
  ...
  3.0e-04   DT              - Recommended module time step (s)
...
---------------------- INPUT FILES ---------------------------------------------
"pazy_ElastoDyn_BDoutputs.dat"    EDFile          - Name of file containing ElastoDyn input parameters (quoted string)
"pazy_BeamDyn.dat"    BDBldFile(1)    - Name of file containing BeamDyn input parameters for blade 1 (quoted string)
"pazy_BeamDyn.dat"    BDBldFile(2)    - Name of file containing BeamDyn input parameters for blade 2 (quoted string)
"pazy_BeamDyn.dat"    BDBldFile(3)    - Name of file containing BeamDyn input parameters for blade 3 (quoted string)
"pazy_InflowWind.dat"    InflowFile      - Name of file containing inflow wind input parameters (quoted string)
"pazy_AeroDyn15.dat"    AeroFile        - Name of file containing aerodynamic input parameters (quoted string)
"pazy_ServoDyn.dat"    ServoFile       - Name of file containing control and electrical-drive input parameters (quoted string)
...
True          SumPrint        - Print summary data to "<RootName>.sum" (flag)
      ...
      0.1   ChkptTime       - Amount of time between creating checkpoint files for potential restart (s)
...
True         VTK_fields       - Write mesh fields to VTK data files? (flag) [true/false] [unused if WrVTK=0]
         100.0   VTK_fps       - Frame rate for VTK output (frames per second)[will use closest integer multiple of DT] [used only if WrVTK=2 or WrVTK=3]
